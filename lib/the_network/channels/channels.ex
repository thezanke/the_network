defmodule TheNetwork.Channels do
  ...
  ## Examples
      ...
      iex> list_articles(channel)
      [%Article{}, ...]

  """
  def list_articles(channel) do
    Article
    |> where([c], c.channel_id == ^channel.id)
    |> Repo.all
  end
  ...
  ## Examples
      ...
      iex> get_article!(channel, 123)
      %Article{}

      iex> get_article!(channel, 456)
      ** (Ecto.NoResultsError)

  """
  def get_article!(channel, id) do
    Article
    |> where([c], c.channel_id == ^channel.id)
    |> Repo.get!(id)
  end
